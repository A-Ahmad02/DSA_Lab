...
class Binary_Node():
    ...
    def product_subtree(self):
        if self.left == None and self.right == None:
            return self.item
        
        if self.left == None:
            self.item = self.item * self.right.product_subtree()
            return self.item
        
        if self.right == None:
            self.item = self.item * self.left.product_subtree()
            return self.item
        self.item = self.left.product_subtree() * self.item * self.right.product_subtree()
        return self.item
